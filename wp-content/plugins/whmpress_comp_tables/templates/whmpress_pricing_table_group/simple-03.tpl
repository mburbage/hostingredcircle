<div id="group_{$random}" class="wpct_table_group simple-03
...
{/if}"
    ...
    <div class="wpct_table_group_row wpct_group_carousel" >
        ...
        >
            ...
            <div class="whmpress whmpress_pricing_table reseller {if $plan.product_id eq $group.important}featured{/if}">
