<div id="group_{$random}" class="wpct_table_group  group-04
...
{/if}"
    ...
    <div class="wpct_table_group_row wpct_group_carousel" >
        ...
        >
			<div class="whmpress whmpress_pricing_table four {if $plan.product_id eq $group.important}featured{/if}">
                <div class="pricing_table_heading">
                    <div class="holder">
                        <h2>
	                        {if $plan.font_awesome ne ""}<i class="fa {$plan.font_awesome}"></i>{/if}
	                        {$plan.name}
                        </h2>
                    </div>
                </div>
