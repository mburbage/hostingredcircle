<style>
	.wpct_hosting_slider.slider-05 .ui-state-default,
	.wpct_hosting_slider.slider-05 .ui-widget-content .ui-state-default,
	.wpct_hosting_slider.slider-05 .ui-widget-header .ui-state-default {
		background: url("{$smarty.const.WPCT_GRP_URL}/images/slider/handle5.png");
		height: 40px;
		width: 40px;
		top: -11px;
		border: 0;
...
<div class="wrapper">
	<div class="wpct_hosting_slider slider-05 wpct_slider_has_toggle" id="slider_{$random}" data-wpct-hide-mobile="{$group.mobile_breakpoint}">
		...
		<div class="wpct_toggle_discount_contianer">
