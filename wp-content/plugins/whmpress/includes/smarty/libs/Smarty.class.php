...
class Smarty extends Smarty_Internal_TemplateBase {
	...
	public static function muteExpectedErrors() {
		/*
			...
			Smarty deliberately uses @filemtime() over is_file() and filemtime() in some places. Reasons include
				- @filemtime() is almost twice as fast as using an additional is_file()
				- between is_file() and filemtime() a possible race condition is opened,
