 ...
 * @since 1.0.0
 */
class Price_Matrix extends Widget_Base
{
    /**
    ...
    {
        return __('Whmpress Price Matrix', 'whmpress');
    }
    ...
    protected function _register_controls()
    {
        ...
        $Files = $WHMPress->get_template_files("whmpress_price_matrix");
        ...
        if (get_option("load_sytle_orders") == "author" || get_option("load_sytle_orders") == "whmpress") {
            ...
            $AllTemplateFiles = $WHMPress->get_all_template_files("whmpress_price_matrix");
