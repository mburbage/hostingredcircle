 ...
 * @since 1.0.0
 */
class Name extends Widget_Base
{
    /**
    ...
    {
        return __('Whmpress Name', 'whmpress');
    }
    ...
    protected function render()
    {
        ...
        echo do_shortcode('[whmpress_name id="' . $id . '" html_id="' . $html_id . '" html_class="' . $html_class . '" ]');
        echo '</div>';
    }
