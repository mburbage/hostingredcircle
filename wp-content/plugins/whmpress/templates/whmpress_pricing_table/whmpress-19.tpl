...
<style>
	...
	#{$random_id}.whmpress.whmpress_pricing_table.whmpress-ninteen{
		 border: none;
		 background-color: #232c3b;
		 border-radius: 35px 35px 35px 35px;
		 padding: 15px 15px 15px 15px;
		 box-shadow: 0px -10px 0px 0px {$primary_color};
		color: #ffffff;
	 }
	#{$random_id}.whmpress.whmpress_pricing_table.whmpress-ninteen .whmpress-icon-host i{
		 color: #ff3800;
		 font-size: 40px;
		margin-bottom: 20px;
	 }
	#{$random_id}.whmpress.whmpress_pricing_table.whmpress-ninteen .pricing_table_heading h2 {
		font-size: 25px;
		font-weight: 900;
		line-height: 1.5em;
		letter-spacing: 1px;
	...
	#{$random_id}.whmpress.whmpress_pricing_table.whmpress-ninteen .pricing_table_detail{
		padding: 0;
		 font-size: 20px;
		 font-weight: 300;
	 }
	#{$random_id}.whmpress.whmpress_pricing_table.whmpress-ninteen .pricing_table_price {
		padding: 15px 0 36px 0;
		font-size: 64px;
		font-weight: 900;
	}
	#{$random_id}.whmpress.whmpress_pricing_table.whmpress-ninteen .pricing_table_price span.currency {
		font-size: 45px;
		font-weight: 900;
		letter-spacing: 5px;
		color: #00ce1b;
	...
	#{$random_id}.whmpress.whmpress_pricing_table.whmpress-ninteen .pricing_table_price span.duration {
		font-size: 20px;
		font-weight: 700;
		color: {$primary_color};
	...
	#{$random_id}.whmpress.whmpress_pricing_table.whmpress-ninteen .pricing_table_features ul {
		padding: 0;
		margin: 0;
	}
	#{$random_id}.whmpress.whmpress_pricing_table.whmpress-ninteen .pricing_table_features ul li{
		padding: 11px 0;
		 font-size: 15px;
		 font-weight: 500;
		 text-transform: uppercase;
	...
	#{$random_id}.whmpress.whmpress_pricing_table.whmpress-ninteen .pricing_table_features ul li i {
		 font-size: 5px;
		 width: 5px;
		 color: #61f400;
...
<div class="whmpress whmpress_pricing_table whmpress-ninteen {$featured}" id="{$random_id}">
