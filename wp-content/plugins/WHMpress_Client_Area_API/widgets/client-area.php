...
class Client_Area extends Widget_Base
{
    /**
    ...
    {
        return __('WCAP Client Area', 'whcom');
    }
    ...
    protected function render()
    {
        ...
        echo do_shortcode('[whmcs_client_area default="' . $default . '" currency="' . $currency . '" promocode="' . $promocode . '" ]');
        echo '</div>';
    }
