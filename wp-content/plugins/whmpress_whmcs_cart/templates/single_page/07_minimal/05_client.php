...
<!--                    <i class="whcom_icon_registered"></i>-->
<!--                    <span>--><?php //esc_html_e('Register New Account', 'whcom')?><!--</span>-->
<!--                </div>-->
...
<!--                <div class="whcom_collapse_toggle">-->
<!--                    <i class="whcom_icon_login"></i>-->
<!--                    <span>--><?php //esc_html_e('Already Registered?', 'whcom')?><!--</span>-->
<!--                </div>-->
<!--                <div class="whcom_collapse_content">-->
<!--                    <div class="whcom_tabs_content wcop_login_form active" id="wcop_sp_user_login">-->
...
<!--            </div>-->
            ...
            <ul class="whcom_tab_links">
                ...
                <li class="whcom_tabs_content active" id="wcop_sp_register_account">
                    <?php echo whcom_render_register_form_fields('client_'); ?>
                </li>
                ...
                <li class="whcom_tabs_content" id="wcop_sp_user_login">
                    <?php echo whcom_render_login_form_fields(); ?>
                </li>
			</ul>
<!--			<div class="whcom_tabs_content active" id="wcop_sp_register_account">-->
