...
<div class="wcop_sp_section_content">
	...
	<?php if ( $taxes_temp['hav_countries'] || empty( get_option( 'whcom_hide_calculate_discount_box', '' ) ) ) { ?>
		<div class="whcom_tabs_container whcom_tabs_fancy_2">
            <div class="whcom_collapse" data-tld-name="<?php echo $tld; ?>">
                <div class="whcom_collapse_toggle">
                    <i class="whcom_icon_gift"></i>
                    <span><?php esc_html_e('Coupon Code', 'whcom')?></span>
                </div>
                    ...
                    <?php if ( strtolower($atts['hide_promo']) != 'yes') { ?>
                        <div class="whcom_tabs_content active" id="wcop_sp_apply_promo_container">
                            <div class="wcop_sp_promo_container">
                                <?php echo wcop_sp_render_promo_html('',$atts['promocode']); ?>
                            </div>
                        </div>
                    <?php } } ?>
                </div>
            ...
            <div class="whcom_collapse whcom_margin_bottom_10" data-tld-name="<?php echo $tld; ?>">
                <div class="whcom_collapse_toggle">
                    <i class="whcom_icon_chart-bar"></i>
                    <span><?php esc_html_e('Estimate Taxes', 'whcom')?></span>
                </div>
                <div class="whcom_collapse_content">
                    <?php if ( $taxes_temp['hav_countries'] ) { ?>
                        <div class="whcom_tabs_content active" id="wcop_sp_estimate_taxes_container">
...
<!--				<div class="whcom_tabs_content active" id="wcop_sp_apply_promo_container">-->
<!--					<div class="wcop_sp_promo_container">-->
<!--						--><?php //echo wcop_sp_render_promo_html(); ?>
<!--					</div>-->
<!--				</div>-->
<!--			--><?php //} } ?>
<!--			--><?php //if ( $taxes_temp['hav_countries'] ) { ?>
...
<!--			--><?php //} ?>
	...
	<?php } ?>
	<div class="wcop_sp_order_summary xs-hidden sm-show">
	</div>
