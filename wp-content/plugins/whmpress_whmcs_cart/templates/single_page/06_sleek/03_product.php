...
<div class="wcop_sp_section_heading">
    ...
    <?php }else { ?>
    <span><?php esc_html_e( "Choose a Hosting Plan (Optional)", "whcom" ) ?></span>
    <?php } ?>
</div>
...
<!--        --><?php //esc_html_e( "Select Product /Service", "whcom" ) ?>
        <div class="open" style="float:right;">
            <?php esc_html_e("Expand","whcom") ?> <i class="whcom_icon_plus"></i>
        </div>
        <div class="whcom_prod_collapse" style="float:right; display: none">
            <?php esc_html_e("Collapse","whcom") ?> <i class="whcom_icon_minus"></i>
        </div>
...
<div class="wcop_sp_section_navi">
    <div class="my-button-item">
        <div class="wcop_sp_button">
            <button type="button" name="prev" class="prev whcom_button_secondary" onclick="Gotoprevious('.sleek_product_section')" style="float: left;"><i class="whcom_icon_angle-circled-left"></i> <?php esc_html_e("Previous","whcom") ?> </button>

            <button type="button" name="next" class="next"  value="continue" onclick="Gotonext('.sleek_product_section')" style="float:right;"> <?php esc_html_e("Next","whcom") ?> <i class="whcom_icon_angle-circled-right"></i></button>
        </div>
    </div>
</div>